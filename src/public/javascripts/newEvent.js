$(function(){
  $("#button").click(function() {
    ...
    document.getElementById("newEventPlace").value = place;
    ...
    //alert(document.getElementById("newEventTag").value);
  	...
  	var summary = document.getElementById("eventTag").value;
    document.getElementById("newEventSummary").value = summary;
